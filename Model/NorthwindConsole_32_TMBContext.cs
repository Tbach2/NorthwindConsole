...
{
    public partial class NorthwindConsole_32_TMBContext : DbContext
    {
        public NorthwindConsole_32_TMBContext()
        {
        }

        public NorthwindConsole_32_TMBContext(DbContextOptions<NorthwindConsole_32_TMBContext> options)
            : base(options)
        {
        }
